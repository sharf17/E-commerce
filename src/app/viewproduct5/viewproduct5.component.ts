...
@Component({
  selector: 'app-viewproduct5',
  templateUrl: './viewproduct5.component.html',
  styleUrls: ['./viewproduct5.component.css']
})
export class Viewproduct5Component implements OnInit {
